...
- [ ] API route map reviewed.
- [ ] UI screen map reviewed.
...
CasePilot can be called production-grade only when the Phase 8 checklist passes and real users can safely manage real cases without developer intervention for normal workflows.
